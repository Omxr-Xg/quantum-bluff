...
\end{tikzpicture}
\caption{Flux de données du prototype MLP expert (\texttt{ExpertPolicy}): vecteur de 36 caractéristiques, couches denses, puis post-traitement métier avant réponse HTTP.}\label{fig:ai-mlp}
\end{figure}

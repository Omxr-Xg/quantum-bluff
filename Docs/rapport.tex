...
\bottomrule
\end{tabular}
\caption{Individual contributions: expanded statements for Omar, Massi, Yigit, Azra, Linda and Mohamed appear as subsections above; remaining rows are summarized from repository ownership notes and should be countersigned by the team.}\label{tab:contrib}
\end{table}

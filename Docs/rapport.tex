...
The repository does not contain signed-off, per-person effort logs, story point assignments, or validated textual attributions beyond the narratives above for Omar, Massi, Yigit and Azra. To satisfy examination requirements, the table below must still be \textbf{completed and countersigned by the team} for remaining members (replace placeholder cells).
...
\bottomrule
\end{tabular}
\caption{Individual contributions: expanded statements for Omar, Massi, Yigit and Azra appear as subsections above; other rows remain self-declared placeholders until completed.}\label{tab:contrib}
\end{table}

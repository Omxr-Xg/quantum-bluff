...
\caption{Texas Hold'em table (practice vs.\ bot): pre-flop state with dealer/SB/BB markers, hole cards, central pot, action bar (\textit{Fold} / \textit{Check} / \textit{Raise}), hand-history snippet, chip balance in the shell header and probability HUD entry via \textit{Probs}.}

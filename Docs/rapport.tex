...
Figure~\ref{fig:flow} shows a \textbf{runtime flow diagram} (logical path, not deployment topology). For more detail, see \path{docs/ARCHITECTURE.md}, Appendix~\ref{app:map}, and Appendix~\ref{app:realtime}.

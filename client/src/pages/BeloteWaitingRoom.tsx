          ...
          <div className="rounded-2xl border border-slate-700 bg-gradient-to-br from-slate-800 to-slate-900 p-6 shadow-2xl">
            ...
            <div className="mb-6 max-h-[400px] space-y-3 overflow-y-auto">
                ...
                >
                  <div className="flex min-w-0 items-center gap-3">
                    <div className="relative shrink-0">
                      ...
                      <div className="absolute bottom-0 right-0 h-5 w-5 rounded-full border-2 border-slate-800 bg-green-500" />
                    </div>
                    <div className="min-w-0">
                  ...
                  <div className="flex shrink-0 flex-col items-end gap-1 sm:flex-row sm:items-center sm:gap-2">
                    <button
                      ...
                      disabled={friendInviteStatus[friend.id] === "pending" || busy}
              ...
              {friendsToInvite.length === 0 ? (
                <div className="py-8 text-center text-gray-400">{t("waitingRoom.noFriendsOnline")}</div>
              ) : null}
            </div>

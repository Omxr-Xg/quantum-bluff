    ...
    <div className="size-full relative overflow-hidden bg-slate-900 flex items-center justify-center min-h-screen p-4 sm:p-6 font-sans">
      ...
      <div className="absolute inset-0">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "repeating-linear-gradient(45deg, transparent, transparent 60px, rgba(139,92,246,0.2) 60px, rgba(139,92,246,0.2) 61px)",
          }}
        />
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              ...
              className={`relative w-full py-4 rounded-[20px] text-[12px] uppercase tracking-[2px] overflow-hidden transition-all duration-300 flex items-center justify-center gap-3 border-[0.1px] ${
                isFormValid
                  ? "bg-[#e81cff] text-white font-semibold shadow-[0_0_30px_5px_rgba(232,28,255,0.6)] border-[#e81cff]"
          ...
          <div className="text-center mt-6">
            <p className="text-sm text-gray-400">
              ...
              <button
                ...
                className="text-[#e81cff] font-semibold hover:underline"
              >
                Créer un compte
              </button>
            </p>

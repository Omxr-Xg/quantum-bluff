    ...
    <div className="pointer-events-none fixed inset-0 z-0" aria-hidden>
      <div className="absolute inset-0 overflow-hidden">
        <img
          src={bacBg}
          alt=""
          className="h-full w-full scale-105 object-cover blur-[6px] brightness-[0.78]"
        />
      </div>
      <div className="absolute inset-0 bg-gradient-to-br from-slate-950/55 via-slate-900/32 to-blue-950/48" />
